...
class ArduinobotTaskActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new ArduinobotTaskFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ArduinobotTaskFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ArduinobotTaskActionFeedback(null);
    ...
    data.feedback = ArduinobotTaskFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ArduinobotTaskActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ArduinobotTaskFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ArduinobotTaskFeedback()
    }
...
module.exports = ArduinobotTaskActionFeedback;
