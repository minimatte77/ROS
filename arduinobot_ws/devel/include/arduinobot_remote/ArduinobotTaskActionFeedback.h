...
#include <arduinobot_remote/ArduinobotTaskFeedback.h>
...
struct ArduinobotTaskActionFeedback_
{
  ...
  _status_type status;
   ...
   typedef  ::arduinobot_remote::ArduinobotTaskFeedback_<ContainerAllocator>  _feedback_type;
...
struct Printer< ::arduinobot_remote::ArduinobotTaskActionFeedback_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::arduinobot_remote::ArduinobotTaskActionFeedback_<ContainerAllocator>& v)
  {
    ...
    s << indent << "feedback: ";
    s << std::endl;
    Printer< ::arduinobot_remote::ArduinobotTaskFeedback_<ContainerAllocator> >::stream(s, indent + "  ", v.feedback);
  }
};
